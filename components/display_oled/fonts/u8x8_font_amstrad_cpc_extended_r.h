/*
  Extracted from u8g2: csrc/u8x8_fonts.c
  ...
  u8g2 is licensed under the 3-clause BSD license.
  The following array is a verbatim copy of the corresponding font data
  from the u8g2 project, kept with attribution.
*/
#ifndef U8X8_FONT_AMSTRAD_CPC_EXTENDED_R_H
#define U8X8_FONT_AMSTRAD_CPC_EXTENDED_R_H
...
static const uint8_t u8x8_font_amstrad_cpc_extended_r[764] = 
...
#endif /* U8X8_FONT_AMSTRAD_CPC_EXTENDED_R_H */
